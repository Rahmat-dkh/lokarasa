<x-guest-layout>
    <div class="text-center mb-6">
        <h1 class="text-2xl sm:text-3xl font-black text-neutral-dark tracking-tighter mb-1">Daftar Vendor.</h1>
        <p class="text-xs sm:text-sm text-slate-500 font-medium">Buat akun untuk mulai berjualan produk UMKM.</p>
    </div>
    ...
    <form method="POST" action="{{ route('vendor.register.store') }}">
        ...
        <div class="mt-3">
            ...
            <p class="text-[10px] text-slate-400 mt-1.5 font-medium">Link ini akan digunakan sebagai alamat toko Anda
                (contoh: localgo.com/toko/<b>nama-toko</b>). Otomatis terisi dari Nama Toko.</p>
