                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
                    ...
                    <div data-aos="fade-left" class="flex flex-col h-full">
                        ...
                        <div class="mt-16 flex flex-col sm:flex-row gap-4">
                            ...
                            <button
                                class="w-full sm:w-auto h-14 sm:h-16 px-8 sm:px-12 glass rounded-[1.5rem] font-black text-neutral-dark hover:bg-white transition-all flex items-center justify-center gap-3 text-base sm:text-lg">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
